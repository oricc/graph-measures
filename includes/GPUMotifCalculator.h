...
private:
	...
	__device__ int GetGroupNumber(std::vector<unsigned int> group);
	...
	// DEVICE VARIABLES
	thrust::device_vector<unsigned int> deviceMotifVariations;
	thrust::device_vector<unsigned int> deviceRemovalIndex;
